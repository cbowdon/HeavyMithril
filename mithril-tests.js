...
function testMithril(mock) {
    ...
    //m
    test(function () {
        return m("div").tag === "div";
    });
    test(function () {
        return m(".foo").tag === "div";
    });
    test(function () {
        return m(".foo").attrs.className === "foo";
    });
    test(function () {
        return m("[title=bar]").tag === "div";
    });
    test(function () {
        return m("[title=bar]").attrs.title === "bar";
    });
    test(function () {
        return m("[title=\'bar\']").attrs.title === "bar";
    });
    ...
    test(function () {
        return m("div", "test").children[0] === "test";
    });
    test(function () {
    ...
    test(function () {
        return m("div", { title: "bar" }, "test0", "test1", "test2", "test3").children[3] === "test3";
    }); // splat
    test(function () {
        return m("div", { title: "bar" }, m("div"), m("i"), m("span")).children[2].tag === "span";
    });
    test(function () {
        return m("div", ["a", "b"]).children.length === 2;
    });
    test(function () {
    ...
    test(function () {
        return m("div", [undefined]).tag === "div";
    });
    test(function () {
    ...
    test(function () {
        return m("svg", [m("a[href='http://google.com']")]);
    });
    test(function () {
    ...
    //m.trust
    test(function () {
        return m.trust("test").valueOf() === "test";
    });
    //m.render
    test(function () {
        var root = mock.document.createElement("div");
    ...
    test(function () {
        var root = mock.document.createElement("div");
        var success = false;
        m.render(root, m("div", { config: function (elem, isInitialized, ctx) {
            ctx.data = 1;
        } }));
        m.render(root, m("div", { config: function (elem, isInitialized, ctx) {
            success = ctx.data === 1;
    ...
    test(function () {
        ...
        mock.requestAnimationFrame.$resolve(); //teardown
        return mock.location.pathname == "/test2" && root.childNodes[0].nodeValue === "foo" && root.childNodes[1].href == "/test2";
    });
    test(function () {
        mock.requestAnimationFrame.$resolve(); //setup
        mock.location.hash = "#";
    ...
    test(function () {
        ...
        var deferred1 = m.deferred();
        var deferred2 = m.deferred();
        m.sync([deferred1.promise, deferred2.promise]).then(function (data) {
            value = data;
        });
    ...
    test(function () {
        var success;
        m.sync([]).then(function (value) {
            success = value instanceof Array;
        });
        return success;
    });
...
//# sourceMappingURL=mithril-tests.js.map