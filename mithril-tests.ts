...
function testMithril(mock: Mithril.MockWindow) {
	...
	test(function() {
		...
		return root.childNodes[0].childNodes[3].childNodes[0].nodeValue === "d" &&
            (<HTMLElement>root.childNodes[0].childNodes[4]).id === "bar"
	})
	test(function() {
		//https://github.com/lhorie/mithril.js/issues/50
		var root = mock.document.createElement("div")
	...
	test(function() {
		...
		mock.requestAnimationFrame.$resolve() //teardown
		return mock.location.search == "?/test14?test&test2="
            && m.route.param("test") === true
            && m.route.param("test2") === ""
	})
	test(function() {
		mock.requestAnimationFrame.$resolve() //setup
